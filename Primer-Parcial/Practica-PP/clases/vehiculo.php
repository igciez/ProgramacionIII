...
class Vehiculo{
    ...
    function cargarVehiculo($arrayDeParametros){
            ...
            foreach($arrayDeParametrosDos as $key => $val){
                ...
                if($auxArray){
                    if(strtolower($auxArray['patente'])===strtolower($arrayDeParametros['patente']) || 
                        ...
                        $contador++;
                        $valorRetornado=true;
                        echo('Ocurrencia '.$contador.':'.' Patente:'.$auxArray['patente'].' Marca:'.$auxArray['marca'].' Kms:'.$auxArray['kms']."\n");
                    }
                }   
            }
            if(!$valorRetornado){
                echo('No existe:'.' Patente:'.$arrayDeParametros['patente'].' Marca:'.$arrayDeParametros['marca'] );
            } 
        }
    }
