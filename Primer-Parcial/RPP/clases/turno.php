...
class Turno{
    ...
    function _construct($fecha, $patente,$marca, $precio,$tipoServicio){
        $this->fecha=$fecha;
                    ...
                    if($auxArrayVehiculos){
                        if($auxArrayVehiculos['patente']===$arrayDeParametros['patente']){                                 
                            foreach($arrayDeParametrosServicio as $key => $val){
                                ...
                                if($auxArrayServicio){
                                    if($auxArrayServicio['precio']===$arrayDeParametros['precio']){
                                        echo ('se guardo el obj');
                                        //$fecha, $patente,$marca,$modelo, $precio,$tipoServicio
                                        $this->_construct($arrayDeParametros['fecha'],$arrayDeParametros['patente'],
                                                $auxArrayVehiculos['marca'],$auxArrayServicio['precio'],$auxArrayServicio['id']);
